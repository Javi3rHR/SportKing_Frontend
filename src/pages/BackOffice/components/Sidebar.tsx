...
export default function Sidebar() {
	return (
		<div className='flex h-screen w-60 flex-col rounded-lg bg-slate-700 p-5 shadow'>
					...
					<ul className='space-y-1 pt-2 pb-4 text-sm'>
						...
						<li className='rounded-sm'>
							...
							>
								...
								<span className='text-gray-100'>Reservations</span>
							</Link>
						</li>
						<li className='rounded-sm'>
